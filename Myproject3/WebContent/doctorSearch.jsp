...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<br>
			<br>
			<form class="form-horizontal" role="form" action="searchdocid" >
				<div class="form-group">
					 <label for="inputDoc" class="col-sm-2 text-center" >按医生ID进行检索:</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name ="doctorID" id="inputDoc"  placeholder="请输入想要查询的医生编号（ID）:">
					</div>
					<div class=" col-sm-1 text-center">
						 <button type="submit" class="btn btn-default active">检索</button>
					</div>
