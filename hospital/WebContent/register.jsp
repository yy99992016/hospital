			...
			<div class="contact-grid">
				...
				<div class="col-md-6 contact-grid-left">
					<form action="patientreg">
						<table class="table">
						<tr><td><input type="text" name ="patientID" placeholder="请输入身份证号或医保卡号或医生编号" required="required"/></td></tr>
						...
						<tr><td><input type="text" name ="utype" placeholder="请输入使用者类型" list = "u_list"/>
						<datalist id="u_list">
						...
						<p class="et">医生填写</p>
						<table class="table">
						<tr><td><input type="text" name ="Area" placeholder="请输入主治领域" required="required"/></td></tr>
						<tr><td><input type="text" name ="Position" placeholder="请输入职位" required="required"/></td></tr>
						<tr><td><input type="text" name ="Ofiice" placeholder="请输入办公室" required="required"/></td></tr>
						</table>
